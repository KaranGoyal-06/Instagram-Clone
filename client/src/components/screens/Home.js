                    ...
                    return (
                        <div className="card home-card" key={item._id}>
                            ...
                            <h5 style={{ padding: "1rem" }} >
                                <Link className="name-link" to={item.postedBy._id !== state._id ? `/profile/${item.postedBy._id}` : "/profile"}
                                ...
                                {item.postedBy._id == state._id //logic for showing delete post icon to only to the user who created it, 
                                    && <i className="material-icons delete-icon" style={{ //delete icon will show if the logic is true
                                        float: "right"
                                    }}
                            ...
                            <div className="card-content">
                                ...
                                <form onSubmit={(e) => {
                                    ...
                                    <button className="btn" type="submit" name="action" style={{ paddingLeft: "1rem", paddingRight: "1rem", paddingTop: "0rem", paddingBottom: "1.5rem" }}>
